...
<html>
    ...
    <body>
        ...
        <p>Žaidėjo pataikymo procentas: <?php echo 100/$visodvit*$pataike;?>% </p>
        <hr>
                <?php
        $tritaskiai=array(0,0);
        ...
        <p>Pataikė: <?php echo $pataike?> </p>
        <p>Nepataikė: <?php echo $nepataike ?>. </p>
        <p>Žaidėjo pataikymo procentas: <?php echo 100/$visotrit*$pataike?>%. </p>
        <br>
